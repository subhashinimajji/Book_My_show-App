...
export default function BookTicketsPage() {
    ...
    return (
        <div style={{ backgroundColor: "#F2F2F2", paddingBottom: 20 ,textAlign:"center" }}>
            <Filter handleFilters={handleFilters} filters={filters} />
            <CinemasBody filters={filters} />
            <HallForm/>
            <br></br>
            <a href="/Payment">
            <button style={{width:'15rem',height:'50%',fontSize:'20px',borderRadius:'55px',backgroundColor:'pink'}}>Make Payment</button>
            </a>
        </div>
    )
}